...
<article>
	<div style="width: 800px; height: 700px; padding: 10px; border: solid 2px #e1e3e9; border-radius:10px;  ">
		<div id="divChatData"></div>
	</div>
	<div style="width: 100%; height: 10%; padding: 10px; ">
		<input type="text" id="message" size="87" onkeypress="if(event.keyCode==13){webSocket.sendChat();}" />
