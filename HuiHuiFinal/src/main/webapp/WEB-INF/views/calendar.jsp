...
<script>	
	...
	$(function() {
		...
		$("button.fc-prev-button").click(function(){
			...
			calendarListMonthMove(startDate);
		});
		
			
		$("button.fc-next-button").click(function(){
			console.log("butto.fc-next-button");
			var localeDate = calendar.getDate().toLocaleString();
			var splitDate = localeDate.substring(0, localeDate.indexOf(" 오전")-1).split(". ");
			var month= splitDate[1] <10 ? "0"+splitDate[1] : splitDate[1];
			var date = splitDate[2] < 10 ? "0" +splitDate[2] : splitDate[2];
	...
	function calendarListMonthMove(startDate){
		$.ajax({
			url:"calendarListMonthMove",
			dataType:"JSON",
			...
			error:function(){
				console.log("ajax error -- calendarListMonthMove");
			}
		});
	}
				...
				<div class="modal-body">
					<div class="form-group">
						<form id="eventForm">
							...
							<input type="hidden" id="emp_id" value="${sessionSecope.id}" />
